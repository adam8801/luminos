...
import 'package:network_2/Page/addPage.dart';
import 'package:network_2/Page/personalPage.dart';
import 'package:network_2/networkHandler.dart';
import 'package:network_2/customUi/decoration.dart';

class PersonalPageList extends StatefulWidget {
  @override
  _PersonalPageListState createState() => _PersonalPageListState();
}

class _PersonalPageListState extends State<PersonalPageList> {
  ...
  void fetchData() async {
    try{
      var response = await networkHandler.get("/page/personalList/0");
  ...
  void fetchData1() async {
    try{
      ...
      var response = await networkHandler.get("/page/personalList/${val.toString()}");
              ...
              children: [
                Column(
                  children: data.map((item) => InkWell(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => PersonalPage(pagename: item.pagename, subtitle: item.subtitle, members: item.members, level: item.level,)));
                    },
