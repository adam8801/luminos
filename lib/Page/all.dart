...
class AllPageList extends StatefulWidget {
  @override
  _AllPageListState createState() => _AllPageListState();
}

class _AllPageListState extends State<AllPageList> {
  ...
  void fetchData() async {
    try{
      var response = await networkHandler.get("/page/list/0");
  ...
  void fetchData1() async {
    try{
      ...
      var response = await networkHandler.get("/page/list/${val.toString()}");
